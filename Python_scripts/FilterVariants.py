#list of variants subjected to signals of selection in the merged African dataset.
...
with open('/ClinVar_2023-06/variant_summary.txt', 'r') as ClinVarInputFile, open('/MainPops/GenesStrongSelection_Diseases.txt', 'w') as ClinVarOutputFile:
...
#Filter by human genome reference GRCh38
...
#Filter by list of variants provided above
